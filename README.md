...
## Setup
- Move "oled-mask@gludwig" folder into "~/.local/share/gnome-shell/extensions" folder.
- May need to logout and login again.
- Enable and change settings with the "Extensions" or "Extensions Manager" application.
